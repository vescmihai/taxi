...
class MapScreenState extends State<MapScreen> {
  ...
  BitmapDescriptor? customDestIcon;
  @override
  void initState() {
    super.initState();
    _loadMarkerImage();  // Añadido para cargar la imagen
  ...
  Future<void> _loadMarkerImage() async {
    customIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(), 'assets/marker11.png');

    customDestIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(), 'assets/marker22.png');
  }
  ...
  void _setDestMarker(LatLng point) {
    setState(() {
      _markers.add(
        Marker(
          icon: customDestIcon ?? BitmapDescriptor.defaultMarker,
